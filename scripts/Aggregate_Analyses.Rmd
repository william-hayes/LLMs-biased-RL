...
Task x LLM x Prompt ANOVA on training phase accuracy.

```{r training-phase-ANOVA}
...
Transfer test accuracy data

```{r transfer-test-accuracy-data}
...
```{r transfer-test-ANOVA-accuracy}
...
Transfer test relative value bias data

```{r transfer-test-bias-data}
...
Task x LLM x Prompt ANOVA on proportion of higher relative value choices.

```{r transfer-test-ANOVA-bias}
